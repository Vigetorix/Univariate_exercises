...
# 2.  Use logistic regression to assess the association between testosterone and breast cancer risk. 
blood.log1 <- glm(case ~ testost, family=binomial(link=logit), data=blood.df)
summary(blood.log1)


# a) Calculate and interpret the Odds Ratio.
exp(0.013891) 
...
# b) Look at the predicted values and visualize them.
...
# c) Create the classification table with different cut-off values.
...
# e) Create the ROC curve, the AUC and interpret.
...
#compare deviances of both models:
